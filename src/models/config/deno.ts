...
export const DenoConfig = Schema.object({
  ...
  fmt: Schema.object({
    ...
    singleBodyPosition: Schema.enum(["maintain", "sameLine", "nextLine"])
      .optional(),
    ...
    trailingCommas: Schema.enum(["never", "always", "onlyMultiLine"])
      .optional(),
    ...
    operatorPosition: Schema.enum(["maintain", "sameLine", "nextLine"])
      .optional(),
    ...
    "jsx.multiLineParens": Schema.enum(["never", "prefer", "always"])
      .optional(),
