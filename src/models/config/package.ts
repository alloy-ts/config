...
export const DevDependencySchema = Schema.record(Schema.string(), Schema.string());
...
export const PackageExportsEntryOrFallback: Schema.ZodType<unknown> = Schema.lazy(() =>
  Schema.union([PackageExportsEntry, PackageExportsFallback]),
);
...
export const PackageImportsEntryOrFallback: Schema.ZodType<unknown> = Schema.lazy(() =>
  Schema.union([PackageImportsEntry, PackageImportsFallback]),
);
